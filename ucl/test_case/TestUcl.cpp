...
TEST_F(TestUcl, Test_Unary_Dot)
{
    char *input = "./ucl/test_case/test_file/test_unary_dot.c";
    char *output = "./ucl/test_case/test_file/test_unary_dot.s";
    ASMFileName = output;
...
TEST_F(TestUcl, Test_Unary_Pointer)
{
    char *input = "./ucl/test_case/test_file/test_unary_pointer.c";
    char *output = "./ucl/test_case/test_file/test_unary_pointer.s";
    ASMFileName = output;
